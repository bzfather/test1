...
def draw_skeleton(aa, kp, show_skeleton_labels=False):
    skeleton = [[0,1], [1,2], [3,4], [4, 5], [6, 7], [6, 8], [2, 6], [6, 3]]

    kp_names = ["rWrist", "rElbow", "rShoulder", "lShoulder", "lElbow", "lWrist", "Torso", "Head", "Stomach"] # Annotated joints
...
def plot_pose3d(pose):
    ...
    _CONNECTION =[[0,1], [1,2], [3,4], [4, 5], [6, 7], [6, 8], [2, 6], [6, 3]]
...
def drawSkeletonPaper(img, kp, colors):
    ...
    kp_names = ["rWrist", "rElbow", "rShoulder", "lShoulder", "lElbow", "lWrist", "Torso", "Head", "Stomach"]
